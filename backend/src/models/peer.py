...
from libs.helpers import get_qrcode_based64, get_wg_private_key, get_wg_public_key, render_template
from models.base import BaseDBModel, Connection
from models.interface import InterfaceDB
...
class PeerDB(BaseDBModel):
    class Meta:
        db_table = f'{DATABASE_WIREGUARD_SCHEMA}"."client_peer'
        PYDANTIC_CLASS = Peer
